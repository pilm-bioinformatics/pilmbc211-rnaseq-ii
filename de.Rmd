...
params=list(
    ...
    metadata= c("group"), # first one used in some plots
    alpha= 0.05,
    lfc= 0,
    slot= "vst",
...
We calculate the different contrasts (comparisons) in a single step with the [degComps](http://lpantano.github.io/DEGreport/reference/degComps.html) function, and all results are stored in a single variable.
...
[Next lesson](https://pilm-bioinformatics.github.io/pilmbc211-rnaseq-ii/run_render.html)
